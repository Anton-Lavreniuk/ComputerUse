...
class GUI:
    def __init__(self, model):
        ...
        self.current_image_path = "screenshot.png"
        self.update_image()
    ...
    def update_image(self):
        if os.path.exists(self.current_image_path):
            # Get the frame size
            frame_width = self.root.winfo_width() // 2 - 40  # Adjust for padding
            frame_height = self.root.winfo_height() - 40  # Adjust for padding
            ...
            self.image_label._image = ctk_image  # Keep a reference
    ...
    def submit_task(self):
        ...
        sleep(1)
        for progress in self.processor.process_task(task):
